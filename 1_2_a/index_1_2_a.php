                    ...
                    <tr>
                        ...
                        <?php if ($per['file']) { ?>
                            ...
                            <td class="d-flex justify-content-center">
                                <a href="?page=1_2_a/index_1_2_a&edit=<?= $per['code']; ?>" class="btn btn-primary">
                                    <div class="icon d-flex">
                                        <i class="bi bi-pencil-square"></i>&nbsp;
                                        <div class="label">แก้ไข</div>
                                    </div>
                                </a>&nbsp;
                                <a onclick="return confirm('ต้องการลบข้อมูลหรือไม่')" href="?page=1_2_a/index_1_2_a&delete=<?= $per['code']; ?>" class="btn btn-danger">
                                    <div class="icon d-flex">
                                        <i class="bi bi-trash"></i>&nbsp;
                                        <div class="label">ลบ</div>
                                    </div>
                        ...
                        <?php } else { ?>
                            <td>
                                <a style="white-space: nowrap;" href="?page=1_2_a/index_1_2_a&upload=<?= $per['code']; ?>" class="btn btn-warning">
                                    <div class="icon d-flex">
