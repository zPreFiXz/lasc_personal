            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action = "1_2_b/insert_1_2_b.php" method="post" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="club"  class="col-sm-2 col-form-label">ชื่อชมรม ชุมนุมหรือที่ปรึกษาอื่นๆ</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="amount_time" class="col-sm-2 col-form-label">จำนวนชั่วโมงทำงาน/สัปดาห์/ภาค (ชม.)</label>
                            <div class="col-sm-10">
