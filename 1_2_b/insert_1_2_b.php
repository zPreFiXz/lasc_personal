<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO personal_1_2_b (club, level, amount_student, group_study, amount_time, amount_work)
        VALUES (:club, :level, :amount_student, :group_study, :amount_time, :amount_work)";
