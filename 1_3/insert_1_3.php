<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO personal_1_3 (userId,Major, level, amount_student, amount_time, workplace, amount_work)
        VALUES (:userId,:Major, :level, :amount_student, :amount_time, :workplace, :amount_work)";
