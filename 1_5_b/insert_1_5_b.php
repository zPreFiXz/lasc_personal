<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO personal_1_5_b (major, level, name_project, amount_teacher, teacher, amount_time, amount_work)
        VALUES (:major, :level, :name_project, :amount_teacher, :teacher, :amount_time, :amount_work)";
