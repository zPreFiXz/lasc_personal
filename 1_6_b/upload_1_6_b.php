<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        if (in_array($fileActExt, $allow)) {
            ...
            if($file['size'] > 0 && $file['error'] == 0 ) {
                ...
                // สร้างคำสั่ง SQL สำหรับอัพเดตชื่อไฟล์ในตาราง personal_1_6_b
                $sql = "UPDATE personal_1_6_b SET file = :file WHERE id = :id";
    ...
    if ($stmt) {
        ...
        header("location: ../index.php?page=1_6_b/index_1_6_b"); // นำทางไปยังหน้า index.php?page=1_6_b
    }else {
