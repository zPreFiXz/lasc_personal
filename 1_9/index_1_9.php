                        ...
                        <tr> <!-- แสดงแถวของตาราง (row) โดยใช้ข้อมูลจากตัวแปร $per ในแต่ละคอลัมน์ของตาราง -->
                            ...
                            <?php if ($per['file']) { ?>
                                <td style="white-space: nowrap;">
                                    ...
                                    <a onclick="return confirm('ต้องการลบไฟล์หรือไม่')" href="?page=1_9/index_1_9&delete_file=<?= base64_encode($per['id']); ?>" class="btn btn-danger">
                                        <div class="icon d-flex">
                                ...
                                <td class="d-flex justify-content-center">
                                    ...
                                    <a href="?page=1_9/index_1_9&edit=<?= base64_encode($per['id']); ?>" class="btn btn-primary">
                                        <div class="icon d-flex">
                                            <i class="bi bi-pencil-square"></i>&nbsp;
                                            <div class="label">แก้ไข</div>
                                        </div>
                                    </a>&nbsp; <!--ปุ่มลบ -->
                                    <a onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่?'); " href="?page=1_9/index_1_9&delete=<?= base64_encode($per['id']) ?>" class="btn btn-danger d-flex">
                                        <div class="icon"></div>
                                        <i class="bi bi-trash"></i>&nbsp;
                            ...
                            <?php } else { ?>
                                <td>
                                    <a style="white-space: nowrap;" href="?page=1_9/index_1_9&upload=<?= base64_encode($per['id']); ?>" class="btn btn-warning">
                                        <div class="icon d-flex">
                                ...
                                <td class="d-flex justify-content-center">
                                    ...
                                    <a onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่?'); " href="?page=1_9/index_1_9&delete=<?= base64_encode($per['id']) ?>" class="btn btn-danger">
                                        <div class="icon d-flex">
                                            <i class="bi bi-trash"></i>&nbsp;
                                            <div class="label">ลบ</div>
                                        </div>
